window.addEventListener("DOMContentLoaded", () => {
  ...
  function carregarPostesPorCidade(nome_municipio = null) {
    const url = nome_municipio ? `/api/postes?nome_municipio=${encodeURIComponent(nome_municipio)}` : "/api/postes";
    fetch(url)
      .then((res) => res.json())
      .then((data) => {
